    ...
    <>
      ...
      <style>{`
        ...
        select {
          ...
          appearance: none;
          border-radius: 0;
          background-image: url("data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20' fill='none' stroke='%238A8371' stroke-width='1.5'><path d='M5 8l5 5 5-5'/></svg>");
